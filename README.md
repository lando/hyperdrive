...
```bash
curl -Ls https://github.com/lando/hyperdrive/releases/download/0.5.1/hyperdrive > /tmp/hyperdrive \
...
```bash
curl -Ls https://github.com/lando/hyperdrive/releases/download/0.5.1/hyperdrive > /usr/local/bin/hyperdrive \
