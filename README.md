...
```bash
curl -Ls https://github.com/lando/hyperdrive/releases/download/v0.5.3/hyperdrive > /tmp/hyperdrive \
...
```bash
curl -Ls https://github.com/lando/hyperdrive/releases/download/v0.5.3/hyperdrive > /usr/local/bin/hyperdrive \
